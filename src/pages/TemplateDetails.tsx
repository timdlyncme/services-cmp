  ...
  const handleDeployTemplate = async () => {
    ...
    try {
      ...
      const deploymentData = {
        ...
        template_id: template.id, // Use the UUID directly, not parseInt
        environment_id: deployEnv, // Use the UUID directly, not parseInt
        environment_name: selectedEnvironment.name,
        provider: template.provider,
        deployment_type: backendDeploymentType,
        template_source: "code",
        template_code: templateCode, // Ensure this is a string
        parameters: parameters || {}
      };
